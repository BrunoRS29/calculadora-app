<template>
  <div class="calculadora">
    ...
    <div v-on:click="quadrado" class="botao operadores"> x<sup>2</sup></div>  
    <div v-on:click="potencia" class="botao operadores"> x<sup>y</sup></div>

    <div v-on:click="sinal" class="botao operadores">+/-</div>
    <div v-on:click="limpar" class="botao operadores">C</div>
    
    <div v-on:click="log" class="botao operadores">log</div>  
    <div v-on:click="logx" class="botao operadores">log<sub>x</sub></div>  
    <div v-on:click="raiz" class="botao operadores"><sup>2</sup>&#8730;x</div>  
    <div v-on:click="raizx" class="botao operadores"><sup>x</sup>&#8730;y</div> 
    ...
    <div v-on:click="resultado" class="botao igual">=</div>  
